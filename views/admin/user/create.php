                    ...
                    <div class="card-body">
                        <?php if (Session::hasErrors()): ?>
                            <div class="alert alert-danger">
                                ...
                                <ul class="mb-0">
                                    <?php foreach (Session::getErrors() as $field => $error): ?>
                                        <li><?= e($error) ?></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        ...
                        <form method="POST" action="<?= url('/admin/user/create') ?>" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="fullName"
                                        ...
                                        value="<?= e(Session::getOldInput('fullName')) ?>">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control"
                                        value="<?= e(Session::getOldInput('phone')) ?>">
                                </div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Địa chỉ</label>
                                <textarea name="address" class="form-control" rows="2"><?= e(Session::getOldInput('address')) ?></textarea>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i> Tạo User
                                </button>
